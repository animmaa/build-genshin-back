...
deckRouter.get('/number/:deck_id/:card_id', deckController.getNumberCardInTheDeck);
...
deckRouter.get('/totalpersonnage/:id', deckController.getPersonnageNumberCardInTheDeck);
