...
deckRouter.get('/:id', checkJwt, deckController.getAllDeckForOneUser);
...
deckRouter.get('/totalcardinthedeck/:id', deckController.getTotalCardInTheDeck);
deckRouter.post('/deckadd/:id', checkJwt, deckController.postCreateDeck);
